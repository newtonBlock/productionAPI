...
os.environ['LANGSMITH_PROJECT'] = 'Agent-simple'
...
async def chat(request: Request, body: ChatRequest):
    ...
    with RequestTimer() as timer:
        ...
        cleaned_message, blocked, notes = security.preprocess(body.message)
...
async def health():
    """Heath check for Docker/Kubernetes."""
    settings = get_settings()
